...
<br>
Two files are needed in the work path, inclduing "label.csv" to provide labels, and "hvg" to provide highly viriable genes. Step 2.1 transforms scRNA-seq expression matrices to tensors. Step 2.2 uses the tensors to perform phenotype prediction and score generation. The outputs of Step 2.2 contain score for each individual, high-impact genes, and high-impcat cells.<br>
<br>
